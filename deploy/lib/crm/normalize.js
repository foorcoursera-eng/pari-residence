 ...
 * @property {string} rooms            интересующая комнатность, если выбрал
 * @property {string} flat             квартира, выбранная на генплане (корпус, этаж, номер)
 ...
 * @property {string} site             с какого сайта заявка (новый дизайн — «pari-redesign»)
...
function toLead(body) {
  return {
    ...
    rooms: clip(body.rooms, 40),
    flat: clip(body.flat, 160),
